...
React.render(React.createElement(TodoApp, null), document.getElementById('container1'));
React.render(React.createElement(TodoApp, null), document.getElementById('container2'));
React.render(React.createElement(TodoApp, null), document.getElementById('container3'));
